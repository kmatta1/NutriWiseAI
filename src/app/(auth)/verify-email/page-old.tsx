...
export default function VerifyEmailPage() {
    ...
    if (!user) {
        return (
            <Card className="mx-auto max-w-md">
                <CardHeader className="text-center">
                    <MailCheck className="mx-auto h-12 w-12 text-destructive" />
                    <CardTitle className="text-2xl font-headline mt-4">Session Lost</CardTitle>
                    <CardDescription>
                        Your session has expired. Please log in again to continue the verification process.
                    </CardDescription>
                </CardHeader>
                <CardContent className="text-center">
                    <p className="text-sm text-muted-foreground mb-4">
                        Don't worry - your account was created successfully. Just log in again to verify your email.
                    </p>
